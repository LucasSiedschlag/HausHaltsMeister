...
| GET | /accounts/{accountId}/credit-cards | viewer |
| POST | /accounts/{accountId}/credit-cards | editor |
| GET | /credit-cards/{cardId} | viewer |
| PATCH | /credit-cards/{cardId} | editor |
| DELETE | /credit-cards/{cardId} | editor |
| POST | /credit-cards/{cardId}/plans | editor |
| GET | /credit-cards/{cardId}/plans | viewer |
| GET | /credit-cards/{cardId}/plans/{planId} | viewer |
| PATCH | /credit-cards/{cardId}/plans/{planId} | editor |
| DELETE | /credit-cards/{cardId}/plans/{planId} | editor |
| GET | /credit-cards/{cardId}/installments | viewer |
| PATCH | /credit-cards/{cardId}/installments/{installmentId} | editor |
| POST | /credit-cards/{cardId}/post | editor |
| GET | /credit-cards/{cardId}/statements | viewer |
| GET | /credit-cards/{cardId}/statements/{statementId} | viewer |
| POST | /credit-cards/{cardId}/statements/close | editor |
| POST | /credit-cards/{cardId}/statements/pay | editor |
| PATCH | /credit-cards/{cardId}/statements/{statementId} | owner |
