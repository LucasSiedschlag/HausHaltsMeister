...
func (s *Store) ListCategories(ctx context.Context, ledgerID string, direction *string, active *bool) ([]categories.Category, error) {
	query := `
...
func (s *Store) GetCategory(ctx context.Context, ledgerID, categoryID string) (categories.Category, error) {
	var item categories.Category
...
func (s *Store) CreateCategory(ctx context.Context, params categories.CreateCategoryParams) (categories.Category, error) {
	var item categories.Category
	row := s.pool.QueryRow(ctx, `
...
func (s *Store) UpdateCategory(ctx context.Context, params categories.UpdateCategoryParams) (categories.Category, error) {
	var item categories.Category
	row := s.pool.QueryRow(ctx, `
		UPDATE categories
...
func (s *Store) DeactivateCategory(ctx context.Context, ledgerID, categoryID string, updatedAt time.Time) error {
...
func (s *Store) IsCategoryUsed(ctx context.Context, ledgerID, categoryID string) (bool, error) {
	var exists bool
	row := s.pool.QueryRow(ctx, `
		SELECT EXISTS (
